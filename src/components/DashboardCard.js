...
const DashboardCard = ({timeRange,selectedDoctorId, hospitalId }) => {
     ...
     {/*<Header timeRange={timeRange} setTimeRange={setTimeRange} />*/}
      <GridContainer>
        <GridItem colStart={1} colEnd={3} rowStart={1} rowEnd={3}>
          <VisitsWidget   hospitalId = {hospitalId} selectedDoctorId= {selectedDoctorId} timeRange={timeRange}/>
        </GridItem>
        <GridItem colStart={3} colEnd={7} rowStart={1} rowEnd={7}>
          <LocationsWidget  hospitalId = {hospitalId} selectedDoctorId= {selectedDoctorId} timeRange={timeRange} />
        </GridItem>
        
        <GridItem colStart={1} colEnd={5} rowStart={3} rowEnd={25}>
          <GenderWidget width={200} height={200}  hospitalId = {hospitalId} selectedDoctorId= {selectedDoctorId} timeRange={timeRange} />
        </GridItem>
        
        <GridItem colStart={6} colEnd={9} rowStart={1} rowEnd={5}>
          <DiscoveryWidget width={150} height={200}  hospitalId = {hospitalId} selectedDoctorId= {selectedDoctorId}  timeRange={timeRange}/>
        </GridItem>
        <GridItem colStart={6} colEnd={9} rowStart={5} rowEnd={9}>
          <AgeGroupWidget  hospitalId = {hospitalId}  selectedDoctorId= {selectedDoctorId} timeRange={timeRange}/>
        </GridItem>
        
        <GridItem colStart={9} colEnd={13} rowStart={1} rowEnd={7}>
          <NewPatientsWidget width={100} height={150}  hospitalId = {hospitalId}  selectedDoctorId= {selectedDoctorId} timeRange={timeRange}/>
        </GridItem> 
      </GridContainer>
    </DashboardContainer>
  );
