...
const LocationsVsDiscovery = ({timeRange,selectedDoctorId,hospitalId}) => {
  ...
  const fetchData = async () => {
    ...
    try {
      const { data, error } = await supabase.rpc('patient_discovery_count_dynamic', {
        ...
        p_secondary_group_by: 'how_did_you_get_to_know_us',
...
export default LocationsVsDiscovery;