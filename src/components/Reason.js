...
//       const { data, error } = await supabase.rpc('get_top_reasons_to_visit', {
//         hospital_id: '4rGAVPwMavcn6ZXQJSqynPoJKyE3',
//         doctor_id: 'custom',
//         uuid: '0c99dde8-1414-4867-9395-26ffe3355f3f', // Example UUID for the doctor or patient
