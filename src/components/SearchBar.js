...
const groq = new Groq({ apiKey: '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', dangerouslyAllowBrowser: true });
...
const SearchBar = () => {
  ...
  const getGroqChatCompletion = async (userQuery) => {
      ...
      messages: [
        {
          ...
          content: `
            ...
            - patients: patient_id, name, address, contact_number, email, created_at, gender, how_did_you_get_to_know_us, date_of_birth
            ...
            - always use hospital_id as '4rGAVPwMavcn6ZXQJSqynPoJKyE3'
    ...
    order by rn desc 
    limit 1;"
            Always respond with the most accurate SQL query that addresses the user's request using MySQL syntax, and ensure that doctor_id and patient_id are considered when relevant.
          `
        },
        {
          role: "user",
